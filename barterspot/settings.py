...
SECRET_KEY = 'django-insecure-&k=)o0@%(eus)%l$@z!tbz-(l7bng+a*^sw!gl1o2n4b(ayrwd'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'barterspot/static')]
